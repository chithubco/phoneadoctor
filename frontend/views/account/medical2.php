        ...
        <div class="col-sm-8 main-container medical-history">          
          ...
          <div class="updt-del">
             <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#step1">Conditions & Symptoms</a></li>
              <li class=""><a data-toggle="tab" href="#step2">Allergies</a></li>
              <li class=""><a data-toggle="tab" href="#step3">Medications or Treatments</a></li>
            </ul>
